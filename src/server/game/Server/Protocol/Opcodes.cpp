...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_BATTLE_PAY_CANCEL_OPEN_CHECKOUT,                    STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayCancelOpenCheckout);
    DEFINE_HANDLER(CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE,               STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayConfirmPurchaseResponse);
    DEFINE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET,           STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayDistributionAssignToTarget);
    DEFINE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS,                 STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayDistributionAssignVas);
    ...
    DEFINE_HANDLER(CMSG_CHARACTER_CHECK_UPGRADE,                            STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharacterCheckUpgrade);
    DEFINE_HANDLER(CMSG_CHARACTER_RENAME_REQUEST,                           STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharRenameOpcode);
    DEFINE_HANDLER(CMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_REQUEST,          STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharacterUpgradeManualUnrevokeRequest);
    ...
    DEFINE_HANDLER(CMSG_GET_VAS_ACCOUNT_CHARACTER_LIST,                     STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleGetVasAccountCharacterList);
    DEFINE_HANDLER(CMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST,                 STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleGetVasTransferTargetRealmList);
    ...
    DEFINE_HANDLER(CMSG_UPDATE_VAS_PURCHASE_STATES,                         STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateVasPurchaseStates);
