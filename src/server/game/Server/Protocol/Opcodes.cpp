...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_CONFIRM_PREVIEW_PLACEMENT,            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_COMPLETE_TUTORIAL_STEP,                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_QUERY_PENDING_INVITES,                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_SET_TUTORIAL_STATE,                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_SKIP_TUTORIAL,                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL);
