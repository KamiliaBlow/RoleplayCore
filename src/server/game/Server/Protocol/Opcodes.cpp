...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_GET_NEIGHBORHOOD_INITIATIVE_INFO_REQUEST,           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetNeighborhoodInitiativeInfoRequest);
    ...
    // 12.0.5 IDA-decoded NeighborhoodInitiative ? wire formats verified at
    // INITIATIVE_WIRE_FORMAT_AUTHORITATIVE_67186.md. Lua-API ? opcode 1:1 binding still
    // requires runtime sniff (vtable indirection blocks static resolution).
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_01,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp01);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_05,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp05);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_06,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp06);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_07,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp07);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_08,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp08);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_09,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp09);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0A,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp0A);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0B,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp0B);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0C,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodInitiativeOp0C);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BULK_REFUND_RESPONSE,                                         STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CATALOG_SHOP_LICENSE_DATA,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CATALOG_SHOP_OBTAIN_LICENSE,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CATALOG_SHOP_OPEN_CHECKOUT_RESULT,                            STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHROMIE_TIME_SELECT_EXPANSION_SUCCESS,                        STATUS_NEVER,       CONNECTION_TYPE_INSTANCE);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_HOUSING_SVCS_NEIGHBORHOOD_UPDATE_NAME_NOTIFICATION,           STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_CTR_OPTIONS,                                              STATUS_NEVER,       CONNECTION_TYPE_INSTANCE);
