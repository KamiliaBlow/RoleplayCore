...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_HOUSE_EXTERIOR_COMMIT_POSITION,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHouseExteriorSetHousePosition);
    ...
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_CATALOG_CREATE_SEARCHER,              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorRequestStorage);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_CATALOG_DESTROY_ALL_ENTRY_COPIES,     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorDeleteFromStorage);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_CATALOG_DESTROY_ENTRY,                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorDeleteFromStorageById);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_COMMIT_DYES_FOR_SELECTED_DECOR,       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorSetDyeSlots);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_MOVE_DECOR,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorMove);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_PLACE_NEW_DECOR,                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorPlace);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_REMOVE_PLACED_DECOR_ENTRY,            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorRemove);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_SELECT_DECOR,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorLock);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_SET_EDITOR_MODE_ACTIVE,               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorSetEditMode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_START_PLACING_NEW_DECOR,              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingDecorRedeemDeferredDecor);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_REMOVE_FIXTURE_FROM_SELECTED_POINT, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingFixtureDeleteFixture);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SELECT_CORE_FIXTURE_OPTION,         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingFixtureSetCoreFixture);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SELECT_FIXTURE_OPTION,              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingFixtureCreateFixture);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_EDITOR_MODE_ACTIVE,             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingFixtureSetEditMode);
    DEFINE_HANDLER(CMSG_HOUSING_KIOSK_REQUEST_HOUSING_RESET,                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingResetKioskMode);
    DEFINE_HANDLER(CMSG_HOUSING_REQUEST_CURRENT_HOUSE_INFO,                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingGetCurrentHouseInfo);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_APPLY_THEME,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomSetComponentTheme);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_APPLY_WALLPAPER,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomApplyComponentMaterials);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_MOVE_DRAGGED_ROOM,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomMoveRoom);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_PLACE_ROOM,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomAdd);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_REMOVE_ROOM,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomRemove);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_ROTATE_ROOM,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomRotate);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_EDITOR_MODE_ACTIVE,                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomSetLayoutEditMode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_ROOM_COMPONENT_CEILING_TYPE,       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomSetCeilingType);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_ROOM_COMPONENT_DOOR_TYPE,          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingRoomSetDoorType);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_ACCEPT_NEIGHBORHOOD_OWNERSHIP,     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsAcceptNeighborhoodOwnership);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_CREATE_GUILD_NEIGHBORHOOD,         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsGuildCreateNeighborhood);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_DECLINE_NEIGHBORHOOD_OWNERSHIP,    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsRejectNeighborhoodOwnership);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_ENTER_HOUSE,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsTeleportToPlot);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_GET_OTHERS_BNET_ACCOUNT_OWNED_HOUSES, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsPlayerViewHousesByBnetAccount);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_GET_OTHERS_PLAYER_OWNED_HOUSES,    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsPlayerViewHousesByPlayer);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_GET_PLAYER_OWNED_HOUSES,            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsGetPlayerHousesInfo);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_HOUSE_FINDER_DECLINE_NEIGHBORHOOD_INVITATION, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsDeleteAllNeighborhoodInvites);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_HOUSE_FINDER_REQUEST_NEIGHBORHOODS, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsGetHouseFinderInfo);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_HOUSE_FINDER_REQUEST_RESERVATION_AND_PORT, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsNeighborhoodReservePlot);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_RELINQUISH_HOUSE,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsRelinquishHouse);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_REQUEST_HOUSE_FINDER_NEIGHBORHOOD_DATA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsGetHouseFinderNeighborhood);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_REQUEST_PLAYER_CHARACTER_LIST,     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsGetPotentialHouseOwners);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_SAVE_HOUSE_SETTINGS,               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsUpdateHouseSettings);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_SEARCH_BNET_FRIEND_NEIGHBORHOODS,  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsGetBnetFriendNeighborhoods);
    DEFINE_HANDLER(CMSG_HOUSING_SERVICES_START_TUTORIAL,                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHousingSvcsStartTutorial);
    ...
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_ADD_MANAGER,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodAddSecondaryOwner);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_CANCEL_RESIDENT_INVITATION,            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodCancelInvitation);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_CHARTER_CONFIRMATION_RESPONSE,         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodCharterFinalize);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_CHARTER_CREATE_NEIGHBORHOOD_CHARTER,   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodCharterCreate);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_CHARTER_EDIT_NEIGHBORHOOD_CHARTER,     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodCharterEdit);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_CHARTER_OPEN_CHARTER_CONFIRMATION,     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodCharterOpenConfirmationUI);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_CHARTER_REQUEST_SIGNATURE,             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodCharterSendSignatureRequest);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_CHARTER_SIGN,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodCharterAddSignature);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_DECLINE_NEIGHBORHOOD_INVITATION,       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodPlayerDeclineInvite);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_EVICT_PLAYER,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodEvictPlot);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_GET_HOUSING_INVITATION,                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodPlayerGetInvite);
    ...
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INTERACT_WITH_CORNERSTONE,             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodOpenCornerstoneUI);
    ...
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_OFFER_NEIGHBORHOOD_OWNERSHIP,          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodOfferOwnership);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_PURCHASE_PLOT,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodBuyHouse);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_REMOVE_MANAGER,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodRemoveSecondaryOwner);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_REQUEST_NEIGHBORHOOD_ROSTER,           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodGetRoster);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_SET_NAME,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodUpdateName);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_SET_PUBLIC,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNeighborhoodSetPublicFlag);
