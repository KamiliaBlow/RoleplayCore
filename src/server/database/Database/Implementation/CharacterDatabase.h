...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_DEL_CHARACTER_CUSTOMIZATION,
    CHAR_DEL_CHARACTER_CUSTOMIZATION_CHOICE,
    ...
    // Housing
    CHAR_SEL_CHARACTER_HOUSING,
    CHAR_INS_CHARACTER_HOUSING,
    CHAR_DEL_CHARACTER_HOUSING,
    CHAR_SEL_CHARACTER_HOUSING_DECOR,
    CHAR_INS_CHARACTER_HOUSING_DECOR,
    CHAR_DEL_CHARACTER_HOUSING_DECOR,
    CHAR_SEL_CHARACTER_HOUSING_ROOMS,
    CHAR_INS_CHARACTER_HOUSING_ROOMS,
    CHAR_DEL_CHARACTER_HOUSING_ROOMS,
    CHAR_SEL_CHARACTER_HOUSING_FIXTURES,
    CHAR_INS_CHARACTER_HOUSING_FIXTURES,
    CHAR_DEL_CHARACTER_HOUSING_FIXTURES,
    CHAR_SEL_CHARACTER_HOUSING_CATALOG,
    CHAR_INS_CHARACTER_HOUSING_CATALOG,
    CHAR_DEL_CHARACTER_HOUSING_CATALOG,
    CHAR_UPD_CHARACTER_HOUSING_SETTINGS,
    CHAR_UPD_CHARACTER_HOUSING_EXTERIOR_LOCKED,
    CHAR_UPD_CHARACTER_HOUSING_HOUSE_SIZE,
    CHAR_UPD_CHARACTER_HOUSING_HOUSE_TYPE,
    CHAR_UPD_CHARACTER_HOUSING_POSITION,
    CHAR_UPD_CHARACTER_HOUSING_DECOR_POSITION,
    CHAR_UPD_CHARACTER_HOUSING_DECOR_DYES,
    CHAR_UPD_CHARACTER_HOUSING_DECOR_LOCKED,
    CHAR_UPD_CHARACTER_HOUSING_ROOM,
    CHAR_UPD_CHARACTER_HOUSING_FIXTURE,
    CHAR_DEL_CHARACTER_HOUSING_FIXTURE_SINGLE,
    CHAR_REP_CHARACTER_HOUSING_CATALOG,
    CHAR_UPD_CHARACTER_HOUSING_CATALOG_COUNT,
    CHAR_DEL_CHARACTER_HOUSING_DECOR_SINGLE,
    CHAR_UPD_CHARACTER_HOUSING_NAME_DESC,
    CHAR_UPD_CHARACTER_HOUSING_LEVEL_FAVOR,

    // Neighborhoods
    CHAR_SEL_NEIGHBORHOOD,
    CHAR_INS_NEIGHBORHOOD,
    CHAR_REP_NEIGHBORHOOD,
    CHAR_UPD_NEIGHBORHOOD_PUBLIC,
    CHAR_UPD_NEIGHBORHOOD_NAME,
    CHAR_DEL_NEIGHBORHOOD,
    CHAR_SEL_NEIGHBORHOOD_MEMBERS,
    CHAR_SEL_NEIGHBORHOOD_MEMBER_FIXTURES,
    CHAR_SEL_NEIGHBORHOOD_MEMBER_DECOR,
    CHAR_SEL_NEIGHBORHOOD_MEMBER_ROOMS,
    CHAR_INS_NEIGHBORHOOD_MEMBER,
    CHAR_DEL_NEIGHBORHOOD_MEMBERS,
    CHAR_DEL_NEIGHBORHOOD_MEMBER,
    CHAR_UPD_NEIGHBORHOOD_MEMBER_PLOT,
    CHAR_UPD_NEIGHBORHOOD_OWNER,
    CHAR_UPD_NEIGHBORHOOD_MEMBER_ROLE,
    CHAR_SEL_NEIGHBORHOOD_INVITES,
    CHAR_INS_NEIGHBORHOOD_INVITE,
    CHAR_DEL_NEIGHBORHOOD_INVITES,
    CHAR_DEL_NEIGHBORHOOD_INVITE,

    // Neighborhood Charters
    CHAR_SEL_NEIGHBORHOOD_CHARTER,
    CHAR_SEL_NEIGHBORHOOD_CHARTER_SIGNATURES,
    CHAR_REP_NEIGHBORHOOD_CHARTER,
    CHAR_DEL_NEIGHBORHOOD_CHARTER,
    CHAR_INS_NEIGHBORHOOD_CHARTER_SIGNATURE,
    CHAR_DEL_NEIGHBORHOOD_CHARTER_SIGNATURES,

    // Neighborhood Initiatives
    CHAR_SEL_NEIGHBORHOOD_INITIATIVES,
    CHAR_SEL_NEIGHBORHOOD_INITIATIVE,
    CHAR_INS_NEIGHBORHOOD_INITIATIVE,
    CHAR_UPD_NEIGHBORHOOD_INITIATIVE,
    ...
    CHAR_SEL_CLUB_FINDER_POSTS,
    CHAR_SEL_CLUB_FINDER_APPLICANTS,
    CHAR_INS_CLUB_FINDER_POST,
    CHAR_UPD_CLUB_FINDER_POST,
    CHAR_DEL_CLUB_FINDER_POST,
    CHAR_INS_CLUB_FINDER_APPLICANT,
    CHAR_UPD_CLUB_FINDER_APPLICANT_STATUS,
    CHAR_DEL_CLUB_FINDER_APPLICANT,
    CHAR_DEL_CLUB_FINDER_APPLICANTS_BY_POSTING,
