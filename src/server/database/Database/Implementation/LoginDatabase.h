...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_SEL_BATTLEPAY_PURCHASE_MAXID,
    LOGIN_INS_BATTLEPAY_ENTITLEMENT,
    LOGIN_SEL_BATTLEPAY_ENTITLEMENT_ACCOUNT,
    LOGIN_SEL_BATTLEPAY_ENTITLEMENT_MAXID,
    LOGIN_SEL_BATTLEPAY_ENTITLEMENT_BY_ID,
    LOGIN_SEL_BATTLEPAY_ENTITLEMENT_PENDING_CHAR,
    LOGIN_UPD_BATTLEPAY_ENTITLEMENT_CLAIM,
    LOGIN_UPD_BATTLEPAY_ENTITLEMENT_STATUS,
