...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_CHR_CUSTOMIZATION_MATERIAL,
    HOTFIX_SEL_CHR_CUSTOMIZATION_MATERIAL_MAX_ID,
    ...
    HOTFIX_SEL_CHR_RACE_RACIAL_ABILITY,
    HOTFIX_SEL_CHR_RACE_RACIAL_ABILITY_MAX_ID,
    HOTFIX_SEL_CHR_RACE_RACIAL_ABILITY_LOCALE,
    ...
    HOTFIX_SEL_CRAFTING_DATA,
    HOTFIX_SEL_CRAFTING_DATA_MAX_ID,

    HOTFIX_SEL_CRAFTING_DATA_ITEM_QUALITY,
    HOTFIX_SEL_CRAFTING_DATA_ITEM_QUALITY_MAX_ID,

    HOTFIX_SEL_CRAFTING_DIFFICULTY,
    HOTFIX_SEL_CRAFTING_DIFFICULTY_MAX_ID,

    HOTFIX_SEL_CRAFTING_DIFFICULTY_QUALITY,
    HOTFIX_SEL_CRAFTING_DIFFICULTY_QUALITY_MAX_ID,

    HOTFIX_SEL_CRAFTING_QUALITY,
    HOTFIX_SEL_CRAFTING_QUALITY_MAX_ID,

    HOTFIX_SEL_CRAFTING_REAGENT_QUALITY,
    HOTFIX_SEL_CRAFTING_REAGENT_QUALITY_MAX_ID,
    ...
    HOTFIX_SEL_CREATURE_DISPLAY_INFO_OPTION,
    HOTFIX_SEL_CREATURE_DISPLAY_INFO_OPTION_MAX_ID,
    ...
    HOTFIX_SEL_DATA_TAG_X_HOUSE_DECOR_RECORD,
    HOTFIX_SEL_DATA_TAG_X_HOUSE_DECOR_RECORD_MAX_ID,

    HOTFIX_SEL_DECOR_CATEGORY,
    HOTFIX_SEL_DECOR_CATEGORY_MAX_ID,
    HOTFIX_SEL_DECOR_CATEGORY_LOCALE,

    HOTFIX_SEL_DECOR_DYE_SLOT,
    HOTFIX_SEL_DECOR_DYE_SLOT_MAX_ID,

    HOTFIX_SEL_DECOR_SUBCATEGORY,
    HOTFIX_SEL_DECOR_SUBCATEGORY_MAX_ID,
    HOTFIX_SEL_DECOR_SUBCATEGORY_LOCALE,

    HOTFIX_SEL_DECOR_X_DECOR_SUBCATEGORY,
    HOTFIX_SEL_DECOR_X_DECOR_SUBCATEGORY_MAX_ID,
    ...
    HOTFIX_SEL_EXTERIOR_COMPONENT,
    HOTFIX_SEL_EXTERIOR_COMPONENT_MAX_ID,
    HOTFIX_SEL_EXTERIOR_COMPONENT_LOCALE,

    HOTFIX_SEL_EXTERIOR_COMPONENT_EXIT_POINT,
    HOTFIX_SEL_EXTERIOR_COMPONENT_EXIT_POINT_MAX_ID,

    HOTFIX_SEL_EXTERIOR_COMPONENT_GROUP,
    HOTFIX_SEL_EXTERIOR_COMPONENT_GROUP_MAX_ID,

    HOTFIX_SEL_EXTERIOR_COMPONENT_GROUP_X_HOOK,
    HOTFIX_SEL_EXTERIOR_COMPONENT_GROUP_X_HOOK_MAX_ID,

    HOTFIX_SEL_EXTERIOR_COMPONENT_HOOK,
    HOTFIX_SEL_EXTERIOR_COMPONENT_HOOK_MAX_ID,

    HOTFIX_SEL_EXTERIOR_COMPONENT_TYPE,
    HOTFIX_SEL_EXTERIOR_COMPONENT_TYPE_MAX_ID,
    HOTFIX_SEL_EXTERIOR_COMPONENT_TYPE_LOCALE,

    HOTFIX_SEL_EXTERIOR_COMPONENT_X_GROUP,
    HOTFIX_SEL_EXTERIOR_COMPONENT_X_GROUP_MAX_ID,
    ...
    HOTFIX_SEL_HOUSE,
    HOTFIX_SEL_HOUSE_MAX_ID,

    HOTFIX_SEL_HOUSE_DECOR,
    HOTFIX_SEL_HOUSE_DECOR_MAX_ID,
    HOTFIX_SEL_HOUSE_DECOR_LOCALE,

    HOTFIX_SEL_HOUSE_DECOR_MATERIAL,
    HOTFIX_SEL_HOUSE_DECOR_MATERIAL_MAX_ID,

    HOTFIX_SEL_HOUSE_DECOR_THEME_SET,
    HOTFIX_SEL_HOUSE_DECOR_THEME_SET_MAX_ID,
    HOTFIX_SEL_HOUSE_DECOR_THEME_SET_LOCALE,

    HOTFIX_SEL_HOUSE_EXTERIOR_WMO_DATA,
    HOTFIX_SEL_HOUSE_EXTERIOR_WMO_DATA_MAX_ID,
    HOTFIX_SEL_HOUSE_EXTERIOR_WMO_DATA_LOCALE,

    HOTFIX_SEL_HOUSE_LEVEL_DATA,
    HOTFIX_SEL_HOUSE_LEVEL_DATA_MAX_ID,

    HOTFIX_SEL_HOUSE_LEVEL_REWARD_INFO,
    HOTFIX_SEL_HOUSE_LEVEL_REWARD_INFO_MAX_ID,
    HOTFIX_SEL_HOUSE_LEVEL_REWARD_INFO_LOCALE,

    HOTFIX_SEL_HOUSE_ROOM,
    HOTFIX_SEL_HOUSE_ROOM_MAX_ID,
    HOTFIX_SEL_HOUSE_ROOM_LOCALE,

    HOTFIX_SEL_HOUSE_THEME,
    HOTFIX_SEL_HOUSE_THEME_MAX_ID,
    HOTFIX_SEL_HOUSE_THEME_LOCALE,
    ...
    HOTFIX_SEL_INITIATIVE_CYCLE,
    HOTFIX_SEL_INITIATIVE_CYCLE_MAX_ID,

    HOTFIX_SEL_INITIATIVE_CYCLE_PRIORITY,
    HOTFIX_SEL_INITIATIVE_CYCLE_PRIORITY_MAX_ID,

    HOTFIX_SEL_INITIATIVE_MILESTONE,
    HOTFIX_SEL_INITIATIVE_MILESTONE_MAX_ID,

    HOTFIX_SEL_INITIATIVE_REWARD,
    HOTFIX_SEL_INITIATIVE_REWARD_MAX_ID,
    HOTFIX_SEL_INITIATIVE_REWARD_LOCALE,

    HOTFIX_SEL_INITIATIVE_REWARD_X_MILESTONE,
    HOTFIX_SEL_INITIATIVE_REWARD_X_MILESTONE_MAX_ID,

    HOTFIX_SEL_INITIATIVE_TASK,
    HOTFIX_SEL_INITIATIVE_TASK_MAX_ID,
    HOTFIX_SEL_INITIATIVE_TASK_LOCALE,

    HOTFIX_SEL_INITIATIVE_X_TASK,
    HOTFIX_SEL_INITIATIVE_X_TASK_MAX_ID,
    ...
    HOTFIX_SEL_MCR_SLOT_X_MCR_CATEGORY,
    HOTFIX_SEL_MCR_SLOT_X_MCR_CATEGORY_MAX_ID,

    HOTFIX_SEL_MODIFIED_CRAFTING_CATEGORY,
    HOTFIX_SEL_MODIFIED_CRAFTING_CATEGORY_MAX_ID,
    HOTFIX_SEL_MODIFIED_CRAFTING_CATEGORY_LOCALE,

    HOTFIX_SEL_MODIFIED_CRAFTING_REAGENT_ITEM,
    HOTFIX_SEL_MODIFIED_CRAFTING_REAGENT_ITEM_MAX_ID,
    HOTFIX_SEL_MODIFIED_CRAFTING_REAGENT_ITEM_LOCALE,

    HOTFIX_SEL_MODIFIED_CRAFTING_REAGENT_SLOT,
    HOTFIX_SEL_MODIFIED_CRAFTING_REAGENT_SLOT_MAX_ID,
    HOTFIX_SEL_MODIFIED_CRAFTING_REAGENT_SLOT_LOCALE,

    HOTFIX_SEL_MODIFIED_CRAFTING_SPELL_SLOT,
    HOTFIX_SEL_MODIFIED_CRAFTING_SPELL_SLOT_MAX_ID,
    ...
    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE,
    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_MAX_ID,
    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_LOCALE,


    HOTFIX_SEL_NEIGHBORHOOD_MAP,
    HOTFIX_SEL_NEIGHBORHOOD_MAP_MAX_ID,

    HOTFIX_SEL_NEIGHBORHOOD_NAME_GEN,
    HOTFIX_SEL_NEIGHBORHOOD_NAME_GEN_MAX_ID,
    HOTFIX_SEL_NEIGHBORHOOD_NAME_GEN_LOCALE,

    HOTFIX_SEL_NEIGHBORHOOD_PLOT,
    HOTFIX_SEL_NEIGHBORHOOD_PLOT_MAX_ID,

    HOTFIX_SEL_NPC_MODEL_ITEM_SLOT_DISPLAY_INFO,
    HOTFIX_SEL_NPC_MODEL_ITEM_SLOT_DISPLAY_INFO_MAX_ID,
    ...
    HOTFIX_SEL_ROOM_COMPONENT,
    HOTFIX_SEL_ROOM_COMPONENT_MAX_ID,
    HOTFIX_SEL_ROOM_COMPONENT_OPTION,
    HOTFIX_SEL_ROOM_COMPONENT_OPTION_MAX_ID,
    HOTFIX_SEL_ROOM_COMPONENT_OPTION_TEXTURE,
    HOTFIX_SEL_ROOM_COMPONENT_OPTION_TEXTURE_MAX_ID,
    HOTFIX_SEL_ROOM_COMPONENT_TEXTURE,
    HOTFIX_SEL_ROOM_COMPONENT_TEXTURE_MAX_ID,
    HOTFIX_SEL_ROOM_COMPONENT_TEXTURE_LOCALE,
    HOTFIX_SEL_ROOM_WMO_DATA,
    HOTFIX_SEL_ROOM_WMO_DATA_MAX_ID,
    ...
    HOTFIX_SEL_SPECIALIZATION_SPELLS_DISPLAY,
    HOTFIX_SEL_SPECIALIZATION_SPELLS_DISPLAY_MAX_ID,
    ...
    HOTFIX_SEL_VEHICLE_POI_TYPE,
    HOTFIX_SEL_VEHICLE_POI_TYPE_MAX_ID,
