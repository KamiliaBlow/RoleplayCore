...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_REWARD,
    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_REWARD_MAX_ID,

    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_TASK,
    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_TASK_MAX_ID,
    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_TASK_LOCALE,

    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_X_TASK,
    HOTFIX_SEL_NEIGHBORHOOD_INITIATIVE_X_TASK_MAX_ID,
